...
from scout.season_config import SCOUT_ROOT, SEASON_DIR, build_hitting_divisions
from scout.hitting.gen_hitting import (
...
DEFAULT_OUTPUT = str(SCOUT_ROOT / "data" / "real" / "stat_analysis_report.html")
